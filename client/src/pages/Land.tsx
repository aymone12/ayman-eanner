  ...
  return (
    <div className="bg-[#06141b] grid justify-items-center [align-items:start] w-screen">
      ...
      <div className="hidden md:block bg-[#06141b] w-[1920px] h-[6326px] relative">
        ...
        {/* Bottom Calculator Section - Same design as mobile */}
        <section className="absolute w-[600px] h-[600px] top-[5400px] left-[660px]">
          <Card className="bg-[#06141b] rounded-[20px] shadow-[0px_0px_20px_5px_#2c4a52] border-0 w-full h-full">
            <CardContent className="p-8">
              {/* Grid Type */}
              <div className="mb-8">
                <h3 className="text-white text-xl font-semibold mb-6 [font-family:'Rubik',Helvetica]">Grid Type</h3>
                <RadioGroup
                  value={selectedGridType}
                  onValueChange={setSelectedGridType}
                ...
                >
                  {gridTypeOptions.map((option) => (
                    ...
                    >
                      <div
                        className={`w-full h-[100px] rounded-[15px] border-2 ${
                          selectedGridType === option.id
                            ? "border-white bg-[#0a1b23]"
                            : "border-gray-600 bg-[#0a1b23]"
                        }`}
                      >
                        <div className="relative w-full h-full p-4">
                          ...
                          <div className="absolute top-12 left-12 [font-family:'Inter',Helvetica] font-normal text-white text-sm tracking-[0] leading-[normal]">
                            {option.description}
                          </div>
                        </div>
                      </div>
              ...
              {/* Installation Type */}
              <div className="mb-8">
                <h3 className="text-white text-xl font-semibold mb-6 [font-family:'Rubik',Helvetica]">Installation Type</h3>
                <RadioGroup
                  value={selectedInstallationType}
                  onValueChange={setSelectedInstallationType}
                  className="flex gap-4"
              ...
              {/* Electric Bill */}
              <div className="mb-6">
                <h3 className="text-white text-xl font-semibold mb-6 [font-family:'Rubik',Helvetica]">Electric Bill</h3>
                <div className="flex gap-4 items-end">
                  <div className="relative flex-1">
                    <Input
                      ...
                      value={electricBill}
                      onChange={(e) => setElectricBill(e.target.value)}
                      className="w-full px-4 py-4 rounded-[15px] border-2 border-gray-600 bg-[#0a1b23] text-white placeholder:text-gray-400 text-lg focus:border-white focus:ring-0"
                      data-testid="input-electric-bill-bottom"
                    />
                    <div className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white text-lg font-light [font-family:'Rubik',Helvetica] pointer-events-none">
                      Dh
                    </div>
                  </div>
                  ...
                  <Button
                    onClick={handleCalculate}
                    className="bg-white text-black px-8 py-4 rounded-[15px] hover:bg-white/90 font-semibold text-lg [font-family:'Rubik',Helvetica] whitespace-nowrap h-[60px]"
                    data-testid="button-calculate-bottom"
                  >
                    Calculate
                  </Button>

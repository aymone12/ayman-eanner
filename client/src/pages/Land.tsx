        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[#06141b] border-t border-[#2c4a52] px-4 py-4 shadow-lg">
            <nav className="space-y-4">
              <div className="space-y-3">
                <button className="flex items-center justify-between w-full text-white text-sm font-bold hover:text-gray-300 transition-colors duration-200 py-2">
                  Company
          ...
          <div className="w-full h-full bg-[#06141b] shadow-[0px_0px_25px_#07151c]">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex items-center">
                ...
                />
                <div>
                  <h1 className="font-bold text-white text-[35px] pt-[0px] pb-[0px] mt-[-12px] mb-[-12px] ml-[-5px] mr-[-5px] pl-[1px] pr-[1px]">
                    eaneer
                  </h1>
                  <div className="text-[6px] text-gray-400 mt-[-2px]">
                    "Elevating A New Energy Era Responsibly"
                  </div>
                </div>
              </div>
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <button className="flex items-center text-white text-sm font-bold hover:text-gray-300 transition-colors duration-200 focus:outline-none">
                  Industry
                  <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
              ...
              {/* Mobile menu button */}
              <button className="md:hidden flex items-center text-white text-sm font-bold hover:text-gray-300">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
